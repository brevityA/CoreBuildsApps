...
> |---|---:|---|---|---|
> | **[Core Builds Icon Pack](#-icon-pack)** | `v1.8.11` | 925 transparent icons + 58 wallpapers for Projectivy Launcher | `5270601` | [`v*` / `iconpack`](../../releases) |
...
`925 icons` · `58 wallpapers` · `v1.8.11`
...
**v1.8.11 — the rest of the D-pad dead ends:** v1.8.10 made the Wallpapers button reachable; this release finishes the job. The update **Download/Install** button, the **"Also &lt;launcher&gt;"** row, the wallpapers **Back** button and the **Select all / Clear / Export** bar were all stranded by focus chains that hopped over them — an available update could not be installed by remote, and multi-select export was unreachable once focus moved. Wallpaper chips also keep their highlight when pressed, and tiles no longer split the focus ring from the click target. A new static check fails the build if any control is left unreachable again. The v1.8.9 Android TV hardening and the 925-icon Core Builds monoline system remain intact. [Mixed-row preview and research](docs/research/icon-fidelity-and-demand-2026-09.md).
