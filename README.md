...
> |---|---:|---|---|---|
> | **[Core Builds Icon Pack](#-icon-pack)** | `v1.8.7` | 925 transparent icons + 50 wallpapers for Projectivy Launcher | `5270601` | [`v*` / `iconpack`](../../releases) |
...
`925 icons` · `50 wallpapers` · `v1.8.7`
