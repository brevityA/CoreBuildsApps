...
> |---|---:|---|---|---|
> | **[Core Builds Icon Pack](#-core-builds-icon-pack)** | `v1.9.6` | 962 transparent icons + 96 wallpapers for Projectivy Launcher | `5270601` | [`v*` / `iconpack`](../../releases) |
> | **[Core Line](#-core-line)** | `v1.3.1` | Sports scores & channel RSS ticker (chyron) | `7375676` | [`coreline-v*` / `coreline`](../../releases) |
