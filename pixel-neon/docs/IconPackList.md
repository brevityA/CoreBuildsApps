...
| AIMI TV | `aimitv` | `#90BE6D` | `com.aimitv.wplg.news/com.whiz.firetv.activity.SplashScreen` |
| Air Attack 2 | `airattack2tv` | `#FEE440` | `com.ArtInGames.AirAttack2tv/com.unity3d.player.UnityPlayerActivity` |
| Aircast | `aircast` | `#FF6B35` | `com.smartdevice.tv.aircast/com.coocaa.icast.ui.home.SplashActivity` |
| Airpin Pro | `airpin_pro` | `#FF6B35` | `com.waxrain.airplaydmr/com.waxrain.ui.WaxPlayerSetting` |
...
| Angel Studios | `angel` | `#9B5DE5` | `com.angel.tv/com.angel.tv.MainActivity` |
| AniLab | `anilab` | `#8AC926` | `com.anilab.android.tv/com.anilab.android.tv.ui.TvActivity` |
| Anime Cast | `anime_cast` | `#9B5DE5` | `csc.app.anime.cast/csc.app.app.tv.activity.Splash`<br>`csc.app.anime.cast/csc.app.app.movil.activity.Splash` |
...
| APKMirror | `apkmirror` | `#F7B32B` | `com.apkmirror.helper.prod/com.apkmirror.presentation.start.StartActivity` |
| APKPure | `apkpure` | `#00BBF9` | `com.apkpure.aegon/com.apkpure.aegon.main.activity.SplashActivity` |
...
| Ard Mediathek | `ard_mediathek` | `#F7B32B` | `de.swr.avp.ard.tv/de.swr.avp.ard.tv.TvActivity` |
| Arrow | `arrowfilms` | `#F7B32B` | `com.arrowfilms/tv.vhx.LauncherActivity`<br>`com.arrowfilms/tv.vhx.tv.home.TvHomeActivity` |
| Arte | `arte` | `#E71D36` | `tv.arte.plus7/tv.arte.plus7.leanback.MainActivity` |
| Artlume | `artlume` | `#B5179E` | `io.artlume.mobile/io.artlume.tv.presentation.MainActivity` |
| Arvio | `arvio` | `#FF6B35` | `com.arvio.tv/com.arflix.tv.MainActivity` |
| AT4K Launcher | `at4k` | `#00E5A0` | `com.overdevs.at4k/com.overdevs.at4k.MainActivity` |
| ATRESplayer | `atresplayer` | `#43AA8B` | `com.antena3.atresplayer.tv/com.antena3.atresplayer.tv.ui.splash.SplashActivity` |
| ATV Tools Server | `atvtools` | `#8B949E` | `dev.vodik7.atvtoolsserver/.MainActivity` |
| Audials | `audials` | `#90BE6D` | `com.audials.paid/com.audials.main.SplashScreenActivity` |
...
| Avoid | `hritwik` | `#B5179E` | `com.hritwik.avoid/com.hritwik.avoid.MainActivity` |
| Award VPN | `award` | `#00BBF9` | `com.award.VPN/app.award.update.SplashActivity` |
...
| Bstation | `bstar` | `#B5179E` | `com.bstar.intl.tv/com.biliintl.ibstartv.MainActivity` |
| Buttons Remapper | `buttonsremapper` | `#FF6B35` | `com.irishin.buttonsremapper/com.irishin.buttonsremapper.ui.MainActivity` |
| Byebyedpi | `byebyedpi` | `#2EC4B6` | `io.github.romanvht.byedpi/io.github.dovecoteescapee.byedpi.activities.MainActivity` |
| Byutv | `byutv` | `#9B5DE5` | `org.byutv.android/org.byutv.android.MainActivity` |
| Cafe Bazaar | `farsitel` | `#9B5DE5` | `com.farsitel.bazaar.tv/com.farsitel.bazaar.tv.ui.splash.SplashActivity` |
| Caixaforum Plus | `caixaforum_plus` | `#6A4C93` | `es.caixaforum.cxplus/com.mediapro.caixaforum.view.splash.SplashActivity` |
| Canal Digital | `canaldigital` | `#8AC926` | `com.canaldigital.go/com.rdyrn.MainActivity` |
| CANAL+ | `canal` | `#F7B32B` | `com.canal.android.canal/com.canal.ui.tv.TvMainActivity` |
| Capsule | `capsule` | `#9B5DE5` | `studio.goodegg.capsule/studio.goodegg.capsule.tv.MainActivity` |
...
| Citytv+ | `citytvplus` | `#577590` | `com.rogers.citytvplus/com.rogers.citytvplus.presentation.LauncherActivity` |
| Clash Meta | `metacubex` | `#8AC926` | `com.github.metacubex.clash.meta/com.github.kr328.clash.MainActivityAlias` |
...
| Couch Puzzles | `couch_puzzles` | `#F7B32B` | `com.roysolberg.couchpuzzles/com.roysolberg.couchpuzzles.AndroidLauncher` |
| CPU Info | `cpuinfo` | `#9B5DE5` | `com.kgurgul.cpuinfo/com.kgurgul.cpuinfo.HostActivity`<br>`com.kgurgul.cpuinfo/com.kgurgul.cpuinfo.tv.TvActivity` |
| Crave | `bellmedia` | `#00F5D4` | `ca.bellmedia.cravetv/axis.androidtv.sdk.app.MainActivity`<br>`ca.bellmedia.cravetv/entpay.awl.awetv.MainActivity` |
...
| Drama Live | `drama_live` | `#00BBF9` | `com.sneig.livedrama/com.sneig.livedrama.activities.StartActivity` |
...
| Dry Bar Comedy Plus | `dry_bar_comedy_plus` | `#FEE440` | `com.vidangel.drybarcomedy/tv.vhx.LauncherActivity`<br>`com.vidangel.drybarcomedy/tv.vhx.tv.home.TvHomeActivity` |
...
| Echogram | `echogram` | `#F94144` | `com.liori.echogram/com.liori.echogram.MainActivity` |
| Elefin | `elefin` | `#F3722C` | `com.flex.elefin/com.flex.elefin.MainActivity` |
| Emby | `emby` | `#52B54B` | `tv.emby.embyatv/.startup.StartupActivity`<br>`com.mb.android/.MainActivity` |
| Enjoy TV | `enjoytvandroid` | `#B5179E` | `com.myenjoytv.enjoytvandroid/com.myenjoytv.enjoytvandroid.SplashActivity` |
| Eon TV | `eon_tv` | `#E71D36` | `com.ug.eon.android.tv/com.ug.eon.android.tv.TvActivity` |
| Epic Channel | `epicchannel` | `#9B5DE5` | `com.epicchannel.epicon/com.epicchannel.epicon.ui.launcher.activity.LauncherActivity` |
...
| FC TV | `fctv77` | `#2EC4B6` | `com.fctv77.tv/com.rblive.launcher.splash.SplashActivity` |
| FCast Receiver | `playstore_2` | `#F94144` | `com.futo.fcast.receiver.playstore/com.futo.fcast.receiver.MainActivity` |
| Feb | `feb` | `#577590` | `com.topspeed.febbox2/com.snowtop.diskpanda.view.activity.SplashActivity` |
| Feeln | `androidapp` | `#43AA8B` | `com.feeln.androidapp/tv.accedo.one.app.bootstrap.BootstrapActivity` |
...
| FileSynced | `filesynced` | `#F94144` | `com.filesynced.app/com.filesynced.app.SplashActivity` |
| Filimo | `filimo` | `#6A4C93` | `com.sabaidea.filimo.tv/com.bluevod.android.tv.ui.activities.MainActivity` |
| Filmfriend | `filmfriend` | `#F15BB5` | `de.filmfriend/crc64a5e6c5f1927a9b79.MainActivity` |
| Filmnet TV | `filmnet_tv` | `#B5179E` | `ir.filmnet.android.tv/ir.filmnet.android.ui.MainActivity` |
| FilmRise | `filmrise` | `#FF6B35` | `com.recipe.filmrise/com.recipe.filmrise.SplashActivity` |
| Filmzie | `platform` | `#F7B32B` | `com.filmzie.platform/com.filmzie.tv.MainActivity` |
| FindLink | `findlink` | `#FF6B35` | `com.findlink/com.findlink.ActivitySplash` |
| Firedown | `firedown` | `#4CC9F0` | `com.solarized.firedown/com.solarized.firedown.phone.BrowserActivity` |
| FireSend | `firesend` | `#90BE6D` | `com.firesend.app/com.firesend.app.MainActivity` |
| FITE | `fitetv` | `#F15BB5` | `com.flipps.fitetv/com.bianor.ams.androidtv.activity.TvMainActivity` |
| Five TV | `fivetviptvbox` | `#90BE6D` | `com.fivetvbox.fivetviptvbox/com.fivetvbox.fivetviptvbox.view.activity.SplashActivity` |
| Fizz TV | `fizz_app` | `#90BE6D` | `ca.fizz_app.tv/ca.vmedia.phones_tablets_ui.activity.MainActivity` |
| Fladder | `fladder` | `#577590` | `nl.jknaapen.fladder/nl.jknaapen.fladder.MainActivity` |
| FLauncher | `launcher` | `#F7B32B` | `com.kfaraj.launcher/com.kfaraj.launcher.LauncherActivity` |
| Flex TV | `flextv` | `#577590` | `com.aytech.flextv/com.android.emptytest.MainActivity`<br>`com.aytech.flextv/com.flex.leanback.ui.splash.TVSplashActivity` |
...
| FM Radio | `fmradio` | `#6A4C93` | `com.radio.fmradio/com.radio.fmradio.activity.OnboardingActivity` |
| Folder Sync | `folder_sync` | `#FF6B35` | `dk.tacit.android.foldersync.lite/dk.tacit.android.foldersync.activity.MainActivity` |
| Football 360 | `football_360` | `#43AA8B` | `tv.football360.androidtv/tv.football360.androidtv.MainActivity` |
| Forecast | `forecast` | `#4CC9F0` | `com.bweather.forecast/com.bweather.forecast.SplashActivity` |
...
| Galaxy Play | `galaxy_play` | `#2EC4B6` | `movies.fimplus.vn.andtv/movies.fimplus.vn.andtv.v2.activity.HomeActivityV2` |
...
| Global TV | `global_tv` | `#43AA8B` | `com.shawmedia.smglobal/com.corusent.stream.activity.SplashScreenActivity` |
...
| Hdhomerun | `hdhomerun` | `#8AC926` | `com.silicondust.view/com.silicondust.view.App` |
| Hdo Box | `hdo_box` | `#43AA8B` | `com.tv.hdobox/com.tv.hdobox.MainActivity` |
| HDRezka | `falcofemoralis` | `#90BE6D` | `com.falcofemoralis.hdrezkaapp/com.falcofemoralis.hdrezkaapp.views.MainActivity` |
| Hdtv Player | `hdtv_player` | `#F94144` | `com.zva3.mobile.litetvandroid/com.zva3.mobile.litetvandroid.MainActivity`<br>`com.zva3.mobile.litetvandroid/com.zva3.mobile.litetvandroid.TvActivity` |
| HEI Network | `heinetworktv` | `#F15BB5` | `com.heinetwork.HEINetworkTV/com.heinetwork.HEINetworkTV.MainActivity` |
| HGTV | `watcher` | `#90BE6D` | `com.hgtv.watcher/com.discovery.tve.presentation.activities.SplashActivity` |
| Hideme | `hideme` | `#577590` | `hideme.android.vpn/com.android.vpn.activities.LoginActivity` |
| Hidive | `hidive` | `#90BE6D` | `com.twentyfouri.androidtv.hidive/com.twentyfouri.androidtv.hidive.MainActivity` |
...
| HISTORY | `androidtv_4` | `#8AC926` | `com.aetn.history.watch.androidtv/com.aetn.android.tveapps.app.MainActivity` |
| History Hit | `historyhit` | `#00BBF9` | `com.historyhit/tv.vhx.tv.home.TvHomeActivity` |
| Hoichoi | `hoichoi` | `#F94144` | `com.viewlift.hoichoi/com.viewlift.hoichoi.ui.splash.MainActivity` |
...
| IPTV Extreme Pro | `iptvextremepro` | `#00F5D4` | `com.pecana.iptvextremepro/com.pecana.iptvextremepro.SplashActivity` |
| IPTV Pro | `iptv_pro` | `#F94144` | `ru.iptvremote.android.iptv.pro/ru.iptvremote.android.iptv.pro.ChannelsActivity` |
...
| Jojoy | `reddish` | `#6A4C93` | `com.reddish.apples/com.jojoy.delegate.JojoyInstallerActivity`<br>`com.reddish.apples/com.reddish.apples.activities.SplashTvActivity` |
...
| Kemo IPTV | `kemo_iptv` | `#00BBF9` | `de.cyberdream.iptv.tv.player/de.cyberdream.dreamepg.MainActivityTV` |
...
| Kuku TV | `kuku_tv` | `#F3722C` | `com.vlv.aravali.reels/com.vlv.aravali.television.MainActivity` |
| L Equipe | `l_equipe` | `#F7B32B` | `lequipe.fr/com.dotscreen.ethanol.tv.ui.MainActivity` |
| L TV Launcher | `ltvlauncher` | `#42A5F5` | `com.leanbitlab.ltvL/com.leanbitlab.ltvL.MainActivity` |
| Laliga | `laliga` | `#2EC4B6` | `la.liga.sports.tv.deporte/la.liga.sports.tv.deporte.features.splash.TvSplashActivity` |
| Lampa | `lampa` | `#FEE440` | `top.rootu.lampa/top.rootu.lampa.MainActivity` |
| Laugh After Dark | `laughafterdark` | `#B5179E` | `com.laughafterdark.androidtv/com.laughafterdark.androidtv.ui.splashscreen.activity.SplashScreenActivity` |
| Launch Sounds | `launchsounds` | `#B5179E` | `com.nvidia.bbciplayer.launchsounds/com.nvidia.bbciplayer.LaunchSoundsActivity` |
| Launchbox | `launchbox` | `#FEE440` | `com.unbrokensoftware.launchbox/crc640d6c5ebcc48c6177.MainActivity` |
| Launcher Manager | `luckymanager` | `#FBBF24` | `com.wolf.google.lm/.main.MainActivity` |
| Launcher Manager | `launcher_manager` | `#00BBF9` | `com.wolf.lm/com.wolf.lm.main.MainActivity` |
| Lazy IPTV Deluxe | `lazyiptvdeluxe` | `#FF477E` | `com.lcs.lazyiptvdeluxe/com.lcs.lazyiptvdeluxe.ActivityStart` |
| LazyCat | `lazycatsoftware` | `#6A4C93` | `com.lazycatsoftware.lmd/com.lazycatsoftware.lazymediadeluxe.ActivityStart` |
| Leanback on Fire | `leanbackonfire` | `#FF9800` | `com.amazon.tv.leanbacklauncher/com.amazon.tv.leanbacklauncher.MainActivity` |
| Leankeyboard | `leankeyboard` | `#F94144` | `org.liskovsoft.androidtv.rukeyboard/com.liskovsoft.leankeyboard.activity.settings.KbSettingsActivity2` |
| Lemino | `lemino` | `#F7B32B` | `jp.ne.docomo.lemino.androidtv/jp.ne.docomo.lemino.androidtv.activities.SplashActivity` |
| Lemuroid | `lemuroid` | `#F7B32B` | `com.swordfish.lemuroid/com.swordfish.lemuroid.app.mobile.feature.main.MainActivity`<br>`com.swordfish.lemuroid/com.swordfish.lemuroid.app.tv.main.MainTVActivity` |
| Lifetime | `androidtv_5` | `#FF6B35` | `com.aetn.lifetime.watch.androidtv/com.aetn.android.tveapps.app.MainActivity` |
| Liga Portugal | `ligaportugal` | `#4CC9F0` | `com.ligaportugal.ligatv/com.ligaportugal.ligatv.SplashActivity` |
| Ligue 1+ | `ligueunpass` | `#F15BB5` | `com.ligueunpass.app/com.ligueunpass.app.MainActivity` |
| Live Channels | `tv` | `#8AC926` | `com.google.android.tv/com.android.tv.TvActivity` |
| Live Streaming TV | `live_streaming_tv` | `#577590` | `com.live_streaming_tv.online_tv/com.live_streaming_tv.online_tv.BitTVActivity` |
| Live TV | `livetv` | `#00BCD4` | `com.mediatek.wwtv.tvcenter/.nav.TurnkeyUiMainActivity` |
| Liverpool FC | `liverpoolfc` | `#00BBF9` | `com.liverpoolfc.goapp/com.applicaster.ui.activities.MainActivity` |
| Localnow | `localnow` | `#43AA8B` | `com.weathergroup.localnow/com.weathergroup.localnow.MainActivity` |
| Locals Google TV | `googletv` | `#F7B32B` | `com.locals.googletv/com.aloteq.flutter_tv.MainActivity` |
| LocalSend | `localsend` | `#008080` | `org.localsend.localsend_app/org.localsend.localsend_app.MainActivity` |
| Loco | `loco` | `#F3722C` | `com.showtimeapp/com.showtimeapp.MainActivity` |
| Lrt | `lrt` | `#4CC9F0` | `lt.lrt.androidtv/com.applicaster.ui.activities.MainActivity` |
| Lumera | `lumera` | `#FFC53D` | `com.lumera.app/com.lumera.app.MainActivity` |
| M3u IPTV | `m3u_iptv` | `#9B5DE5` | `de.herber_edevelopment.m3uiptv/de.herber_edevelopment.m3uiptv.MainActivity`<br>`de.herber_edevelopment.m3uiptv/de.herber_edevelopment.m3uiptv.TvActivity` |
| M6 Plus | `m6_plus` | `#9B5DE5` | `fr.m6.m6replay/com.bedrockstreaming.shared.tv.activity.SplashActivity` |
| M64plus Fz | `m64plus_fz` | `#FF6B35` | `org.mupen64plusae.v3.fzurita/paulscode.android.mupen64plusae.SplashActivity` |
| MagellanTV | `magellantv` | `#00F5D4` | `com.abide.magellantv/com.magellan.tv.splash.SplashActivity` |
| Magenta Sport | `magenta_sport` | `#FF6B35` | `com.telekom.androidtv.sport/com.telekom.firetv.sport.ui.launcher.LauncherActivity` |
| Magenta TV | `magenta_tv` | `#90BE6D` | `cz.tmobile.tvgo/com.telekom.tv.player.StbPlayerActivity`<br>`de.telekom.magentatv.androidtv/de.telekom.magentatv.androidtv.ApplicationMainActivity` |
| Magio TV | `magio_tv` | `#6A4C93` | `com.telekom.magiogo/com.telekom.tv.player.StbPlayerActivity` |
| Mame4droid | `mame4droid` | `#F15BB5` | `com.seleuco.mame4droid/com.seleuco.mame4droid.MAME4droid` |
...
| Matvt Mouse For Android TV Toggle | `matvt_mouse_for_android_tv_toggle` | `#FF477E` | `io.github.virresh.matvt/io.github.virresh.matvt.gui.GuiActivity` |
...
| Maz TV | `combo2254` | `#4CC9F0` | `com.maz.combo2254/com.maz.activities.ViewerLaunchActivity` |
| Maz TV 2 | `combo3403` | `#00F5D4` | `com.maz.combo3403/com.maz.combo3403.MainActivity` |
| Maz TV 3 | `combo3578` | `#F7B32B` | `com.maz.combo3578/com.maz.activities.ViewerLaunchActivity` |
| Maz TVOD | `tvod169` | `#F94144` | `com.maz.tvod169/com.maz.activities.ViewerLaunchActivity` |
| Maze | `powerpoint45` | `#000000` | `com.powerpoint45.maze/com.powerpoint45.maze.MainMenuActivity` |
| Mecool File Manager | `mecool_file_manager` | `#B5179E` | `com.tvonline.filewizard/com.tvonline.filewizard.ui.MainActivity` |
...
| Mediaset Infinity TV | `mediaset_infinity_tv` | `#F94144` | `it.mediaset.infinitytv/it.mediaset.mediasetplay.ctv.MainActivity` |
| MEGOGO | `application` | `#B5179E` | `com.megogo.application/net.megogo.tv.main.MainActivity` |
| MEO | `alticelabs` | `#2EC4B6` | `com.alticelabs.meo.androidtv/com.alticelabs.meo.androidtv.features.splash.ui.SplashActivity` |
| Mercado Play | `mercado_play` | `#FF6B35` | `com.mercadolibre.android.mplay_tv/com.mercadolibre.android.mplay_tv.app.feature.splash.SplashActivity` |
...
| Mewatch | `mewatch` | `#F15BB5` | `sg.mediacorp.android/axis.androidtv.sdk.app.startup.ui.StartupActivity` |
| MGM+ | `epix` | `#43AA8B` | `com.epix.epix.now/com.epix.presentationtv.splash.SplashActivity` |
| MGS TV | `mgstv` | `#F3722C` | `com.android.mgstv/com.interactive.brasiliptv.ui.activity.WelcomeActivity` |
...
| Monplayer | `monplayer` | `#2EC4B6` | `org.monplayer.mpapp/org.monplayer.mpapp.MainActivity` |
| Moonfin | `moonfin` | `#6A4C93` | `org.moonfin.androidtv/org.jellyfin.androidtv.ui.startup.StartupActivity` |
| Moonlight | `moonlight` | `#76B900` | `com.limelight/.PcView` |
| Moonlight Noir | `limelight` | `#F7B32B` | `com.limelight.noir/com.limelight.PcView` |
| MotoGP | `officialmotogp` | `#90BE6D` | `com.dorna.officialmotogp/com.dorna.motogpapp.ui.view.tv.splash.SplashTVActivity` |
| Movideo | `whitelabel` | `#4CC9F0` | `com.movideo.whitelabel/com.movideo.whitelabel.MainActivity` |
| Movie HD | `moviehd` | `#B5179E` | `com.ggateam.moviehd.ui/com.ggateam.moviehd.ui.FrmSplash` |
...
| Mytvonline | `mytvonline` | `#E71D36` | `m.formuler.mol.plus/m.formuler.mol.plus.IntroActivity` |
...
| Netfly | `netfly` | `#2EC4B6` | `br.com.netfly.oletv/br.tv.ole.oletv.MainActivity` |
| Netfly TV | `netfly_tv` | `#F94144` | `xyz.netfly/com.video_cloud.SplashActivity` |
| NetMirror | `netmirror` | `#8AC926` | `app.netmirror.newtv/app.netmirror.newtv.MainActivity` |
...
| Notifications For Android TV | `notifications_for_android_tv` | `#F94144` | `de.cyberdream.androidtv.notifications.google/de.cyberdream.androidtv.notifications.StartActivity`<br>`de.cyberdream.androidtv.notifications.google/de.cyberdream.smarttv.leanback.MainActivityLeanBack` |
| Notubetv | `notubetv` | `#F3722C` | `com.ycngmn.notubetv/com.ycngmn.notubetv.MainActivity` |
| Nova Video Player | `nova_video_player` | `#2EC4B6` | `org.courville.nova/com.archos.mediacenter.video.leanback.MainActivityLeanback` |
| NOW | `nowtv` | `#001211` | `com.bskyb.nowtv.beta/com.peacock.peacocktv.GoogleMainActivity` |
| Nowo TV | `nowo_tv` | `#43AA8B` | `pt.nowo.nowotv.androidtv/com.androme.andrometv.ui.boot.SplashScreenActivity` |
| Npo Start | `npo_start` | `#00BBF9` | `nl.uitzendinggemist/nl.uitzendinggemist.tv.presentation.activities.main.MainActivity` |
| Nrk TV | `nrk_tv` | `#9B5DE5` | `no.nrk.tv/no.nrk.tv.view.MobileSplashScreenActivity`<br>`no.nrk.tv/no.nrk.tv.view.TvSplashScreenActivity` |
| NT at Home | `ntathome` | `#2EC4B6` | `com.ntathome/tv.vhx.LauncherActivity`<br>`com.ntathome/tv.vhx.tv.home.TvHomeActivity` |
...
| NV Player | `nvplayer` | `#00F5D4` | `com.acb.nvplayer/com.ae.video.bplayer.ui.SplashActivity` |
| Nxsha | `nxsha` | `#E71D36` | `com.nxsha/com.nxsha.MainActivity` |
| NZR+ | `nzrplus` | `#6A4C93` | `com.nzrplus.app/com.nzrplus.app.MainActivity` |
| Oblivion | `oblivion` | `#FF477E` | `org.bepass.oblivion/org.bepass.oblivion.ui.SplashScreenActivity` |
| Obtainium | `obtainium` | `#D2BCFD` | `dev.imranr.obtainium.fdroid/dev.imranr.obtainium.MainActivity` |
| Ocean Streamz | `ocean_streamz` | `#B5179E` | `streamzy.com.ocean/streamzy.com.ocean.activities.SplashScreenActivity` |
| Odidotv | `odidotv` | `#FF477E` | `com.tmobile.tv.nl/com.zodiac.tv.presentation.common.layouts.ZodiacActivity` |
| Offshore | `offshore` | `#90BE6D` | `com.offshore.pikachu/com.offshore.pikachu.view.Splash` |
| Oilers+ | `oilers` | `#B5179E` | `com.oilers.app/com.imggaming.dicemobile.MainActivity` |
| OK TV | `oktv22` | `#FEE440` | `com.iptv.OKTV22/com.iptv.vsaclient.Main` |
| Ok Video | `ok_video` | `#FF477E` | `ru.ok.androidtv/ru.ok.androidtv.activities.MainActivity` |
| Old Movies | `oldmovies` | `#F3722C` | `com.acowboys.oldmovies/com.iart.chromecastapps.atv.ATVOnBoarding`<br>`com.acowboys.oldmovies/com.iart.chromecastapps.onboarding.OnBoardingNew` |
| Omroep Brabant | `appomroepbrabant` | `#9B5DE5` | `com.appomroepbrabant/com.applicaster.ui.activities.MainActivity` |
| Ondamedia | `ondamedia` | `#E71D36` | `com.mdstrm.ondamedia/com.mdstrm.ondamedia.MainActivity` |
| One Play | `one_play` | `#2EC4B6` | `net.cme.voyo.cz.tvapp/net.cme.voyo.cz.tvapp.MainActivity` |
...
| ORF ON | `orftvthek` | `#4CC9F0` | `com.nousguide.android.orftvthek/com.nousguide.android.orftvthek.MainActivity` |
| OSN+ | `osn` | `#00F5D4` | `com.osn.go/com.osn.go.MainActivity` |
| Otf TV | `otf_tv` | `#F94144` | `com.t100v.otf/com.t100v.otf.intro` |
| Ott Navigator | `ott_navigator` | `#00BBF9` | `studio.scillarium.ottnavigator/studio.scillarium.ottnavigator.MainActivity` |
| OTTplay | `ottplay` | `#90BE6D` | `com.ottplay.ottplay/com.ottplay.ottplay.StartActivity` |
| Ottplayer | `ottplayer` | `#E71D36` | `es.ottplayer.tv/es.ottplayer.tv.SplashActivity` |
| Overseas App Store | `appstore` | `#B5179E` | `com.overseas.store.appstore/com.overseas.store.appstore.ui.SplashActivity` |
...
| Perfect TV | `perfecttv` | `#9B5DE5` | `com.perfecttv.apks/com.gbscell.aipitv.SplashActivity` |
| Philo | `philo` | `#B5179E` | `com.philo.philo.google/com.philo.philo.app.activity.MainActivity` |
| Photo Collage | `photocollage` | `#6A4C93` | `com.oe.photocollage/com.oe.photocollage.SplashActivity` |
| Photo Screensaver | `photoscreensaver` | `#F15BB5` | `com.furnaghan.android.photoscreensaver/com.furnaghan.android.photoscreensaver.gallery.GalleryBrowseActivity` |
...
| PikPak | `pikcloud` | `#00F5D4` | `com.pikcloud.pikpak/com.pikcloud.app.SplashActivity`<br>`com.pikcloud.pikpak/com.pikcloud.app.TVLaunchActivity` |
| Play Now | `playnow` | `#2EC4B6` | `com.play.playnow.tv/com.n7mobile.playbox.ui.MainActivity` |
| Play Suisse | `playsuisse` | `#43AA8B` | `ch.srgssr.playsuisse.tv/ch.srgssr.playsuisse.tv.MainActivity` |
| Play Universal | `universal` | `#FEE440` | `com.play.universal/com.play.universal.MainActivity` |
| Player | `player` | `#00BBF9` | `pl.tvn.player.tv/pl.redlabs.redcdn.portal.ui.main.MainActivity` |
| Playfy | `playfy` | `#4CC9F0` | `com.playfy.tv/com.playfy.tv.activities.SplashActivity` |
...
| Ppsspp | `ppsspp` | `#FF477E` | `org.ppsspp.ppsspp/org.ppsspp.ppsspp.PpssppActivity` |
| Premier Sports | `premier_sports` | `#FF6B35` | `premierplayer.premiersports.com.premierplayer/com.premiersports.premiersportstv.ui.login.DeviceLinkActivity` |
| Premiere FC | `premierefc` | `#9B5DE5` | `br.tv.horizonte.android.premierefc/br.tv.horizonte.android.premierefc.splash_tv.SplashTvActivity` |
...
| Quickbars For Home Assistant | `quickbars_for_home_assistant` | `#B5179E` | `dev.trooped.tvquickbars/dev.trooped.tvquickbars.ui.SplashActivity` |
| Quicksupport | `quicksupport` | `#F7B32B` | `com.teamviewer.quicksupport.market/com.teamviewer.quicksupport.ui.QSActivity` |
| Radio Net | `radio_net` | `#00BBF9` | `de.radio.android/de.radio.android.tv.activities.TvMainActivity` |
| Radio On TV | `radio_on_tv` | `#E71D36` | `de.fitzood.radio.tv/de.fitzood.radio.tv.MainActivity` |
| Radio Paradise | `radioparadisewidget` | `#FF477E` | `com.earthflare.android.radioparadisewidget.gpv2/com.cratorsoft.act.ActRPHD`<br>`com.earthflare.android.radioparadisewidget.gpv2/com.cratorsoft.act.ActRPHD_` |
...
| RB Live | `rblive` | `#F94144` | `com.rblive.app/com.rblive.launcher.splash.SplashActivity` |
| RB Main | `rbmain` | `#4CC9F0` | `app.rbmain.tv/com.example.vod.pages.main.MainActivity` |
| Real America's Voice | `americasvoicenews` | `#4CC9F0` | `com.americasvoicenews.androidtv/com.americasvoicenews.androidtv.MainActivity` |
...
| Remote Starter For Yatse | `remote_starter_for_yatse` | `#FF477E` | `tv.yatse.android.remotestarter/tv.yatse.android.remotestarter.ui.MainActivity` |
| Replaio Radio | `replaio` | `#F94144` | `com.hv.replaio/com.hv.replaio.activities.tv.StartActivityTV` |
| RetroArch | `retroarch` | `#000000` | `com.retroarch/com.retroarch.browser.mainmenu.MainMenuActivity` |
| RetroX | `archain` | `#00F5D4` | `com.archain.retrox/com.unity3d.player.UnityPlayerActivity` |
| Rezka | `rezka` | `#9B5DE5` | `ru.astroapps.hdrezka/ru.astroapps.hdrezka.MainActivity` |
| Riks TV | `riks_tv` | `#B5179E` | `no.rikstv.atv/no.rikstv.atv.MainActivity` |
| RlaXX TV | `rlaxxtv` | `#00BBF9` | `com.rlaxxtv.tvapp.atv/com.rlaxxtv.tvapp.MainActivity` |
| RLC+ | `rlcplus` | `#F3722C` | `com.rlcplus.app/com.rlcplus.app.MainActivity` |
| RMC BFM | `nextinteractive` | `#00BBF9` | `com.nextinteractive.rmcbfmplay.tv.sfr/com.nextinteractive.rmcbfmplay.apptv.SplashActivity` |
...
| RSI Play | `rsi` | `#00F5D4` | `ch.rsi.player/ch.srg.srgplayer.tv.MainActivity` |
...
| RTL Play | `rtl_play` | `#FEE440` | `com.tapptic.rtl.tvi/be.persgroep.rtlplay.RtlPlayMainActivity` |
...
| Saff | `saff` | `#43AA8B` | `sa.saffplus/com.mottostreaming.android.tv.MainActivity` |
...
| Scb Next | `scb_next` | `#8AC926` | `com.scb.next/com.scb.next.SplashActivity` |
| Scholastic | `scholastic` | `#E71D36` | `com.future.scholastic/com.future.scholastic.SplashActivity` |
| Screenscape | `screenscape` | `#F7B32B` | `com.screenscape/com.screenscape.MainActivity` |
| Sd Maid | `sd_maid` | `#FEE440` | `eu.thedarken.sdm/eu.thedarken.sdm.main.ui.SDMMainActivity` |
| SD Maid SE | `sdmaid` | `#8BC34A` | `eu.darken.sdmse/.main.ui.MainActivity` |
| SeerrTV | `seerrtv` | `#F94144` | `ca.devmesh.seerrtv/ca.devmesh.seerrtv.MainActivity` |
...
| Seven Plus | `seven_plus` | `#FF6B35` | `com.swm.live/au.com.seven.inferno.ui.setup.SetupActivity`<br>`com.swm.live/au.com.seven.inferno.ui.tv.setup.SetupTvActivity` |
...
| Shahid | `shahid` | `#FEE440` | `net.mbc.shahidTV/net.mbc.shahidTV.MainActivity` |
| Shark TV | `sharktvthree` | `#00BBF9` | `com.nathnetwork.sharktvthree/com.nathnetwork.sharktvthree.SplashVideoActivity` |
...
| Snrt Live | `snrt_live` | `#E71D36` | `ma.snrt.live/ma.snrt.snrtLive.snrt_live_tv_app.MainActivity` |
| Sofascore | `sofascore` | `#43AA8B` | `com.sofascore.results/com.sofascore.results.main.MainActivity` |
...
| Sweet TV | `sweet_tv` | `#E71D36` | `tv.sweet.tvplayer/tv.sweet.tvplayer.MainActivity` |
| SYFY | `androidtv_8` | `#00F5D4` | `com.nbcu.tve.syfy.androidtv/com.nbc.nbctvapp.ui.main.view.MainActivity` |
...
| TCL Channel | `tcl_channel` | `#00BBF9` | `com.tcl.waterfall.overseas/com.tcl.waterfall.overseas.main.MainActivity` |
| TCL Home | `tcl_home` | `#B5179E` | `com.tcl.tclhome/com.tcl.bmmain.SplashActivity` |
| Tcn | `tcn` | `#FF6B35` | `com.tuckercarlson.tv/tv.accedo.one.app.bootstrap.BootstrapActivity` |
| Tdtchannels Player | `tdtchannels_player` | `#8AC926` | `com.tdtchannels.player/com.tdtchannels.player.SplashScreenActivity` |
| Tduk Screensaver Manager | `tduk_screensaver_manager` | `#90BE6D` | `com.tduk.scrmgr/dev.vodik7.tdukscrmng.MainActivity` |
| Ted | `ted` | `#E62B1E` | `com.ted.android.tv/com.ted.android.tv.view.MainActivity` |
| Tele Quebec | `tele_quebec` | `#4CC9F0` | `tv.telequebec/uk.tva.template.LaunchScreenActivity` |
| Tele2 Play | `tele2_play` | `#B5179E` | `com.tivo.android.comhem/com.comhem.mandel.mobile.presentation.NavigationActivity`<br>`com.tivo.android.comhem/tv.threess.threeready.ui.generic.activity.MainActivity` |
| Telenet | `telenet` | `#6A4C93` | `be.telenet.tv/com.libertyglobal.horizonx.MainActivity` |
| Telewebion | `telewebion` | `#F94144` | `tv.telewebion/tv.telewebion.ui.main.MainActivity` |
| Teliaplaylt | `teliaplaylt` | `#F3722C` | `lt.telia.tv/lt.telia.tv.MainActivity` |
| Telly | `telly` | `#4CC9F0` | `tv.fournetwork.android.box.digi/tv.fournetwork.android.box.MainActivity` |
...
| Tflix | `tflix` | `#E71D36` | `com.tflix.live/com.tflix.live.tv.TvSplashActivity` |
| Tg4 Player | `tg4_player` | `#577590` | `ie.bytes.tg4.tg4videoapp/ie.bytes.tg4.tg4videoapp.tv.TVActivity` |
| The Comedy Channel | `thecomedychannel` | `#4CC9F0` | `com.megastream.androidtv.thecomedychannel/com.megastream.androidtv.thecomedychannel.MainActivity` |
| The Roku Channel | `the_roku_channel` | `#6A4C93` | `com.roku.web.trc/com.roku.web.trc.MainActivity` |
| The Weather Network | `weathereyeandroid` | `#FF6B35` | `com.pelmorex.WeatherEyeAndroid.tv/com.pelmorex.WeatherEyeAndroid.tv.ui.activities.SplashActivity` |
...
| TNA Wrestling | `fight` | `#00F5D4` | `com.fight.tna/com.fight.tna.MainActivity` |
| TNT | `tnt` | `#B5179E` | `com.turner.tnt.android.networkapp/com.wme.app.MainActivityTv` |
| Tod | `tod` | `#F94144` | `com.todtv.tod/com.todtv.tod.MainActivity` |
...
| Trilogy Plus | `trilogy_plus` | `#F3722C` | `ott.trilogyplus/tv.vhx.LauncherActivity`<br>`ott.trilogyplus/tv.vhx.tv.home.TvHomeActivity` |
...
| TV Browser | `tvbrowser` | `#F3722C` | `com.internet.tvbrowser/com.internet.tvbrowser.MainActivity` |
| TV Everywhere | `tveverywhere` | `#FF6B35` | `com.kableone.tveverywhere/com.kableone.tveverywhere.ui.main.view.activity.SplashScreenActivity` |
| TV Garden | `tv_garden` | `#F94144` | `com.tvgarden/com.tvgarden.MainActivity` |
...
| Tv2 Play | `tv2_play` | `#FF477E` | `dk.tv2.tv2play/dk.tv2.tv2play.ui.main.MainActivity` |
| Tv360 | `tv360` | `#FF477E` | `com.viettel.tv360.tv/com.viettel.tv360.tv.screen.splash.SplashActivity` |
...
| TVA+ | `tvaplus` | `#00BBF9` | `com.numeriq.tvaplus/ade.tv.main.ui.splash.SplashActivity` |
| Tvi Player | `tvi_player` | `#9B5DE5` | `pt.iol.tviplayer.androidtv/pt.iol.tviplayer.androidtv.MainActivity` |
| Tving | `tving` | `#E71D36` | `net.cj.cjhv.gs.tving/net.cj.cjhv.gs.tving.view.scaleup.ScaleupIntroActivity` |
| Tvnzplus | `tvnzplus` | `#8AC926` | `nz.co.tvnz.ondemand.tv/nz.co.tvnz.ondemand.SplashScreenTVActivity` |
| Tvo Kids | `tvo_kids` | `#FF477E` | `com.tvokids.tvokids/tv.accedo.one.app.bootstrap.BootstrapActivity` |
| Tvo Today | `tvo_today` | `#43AA8B` | `org.tvo.tvoott/tv.accedo.one.app.bootstrap.BootstrapActivity` |
| Tvoverlay | `tvoverlay` | `#F94144` | `com.tabdeveloper.tvoverlay/com.tabdeveloper.tvoverlay.SetupActivity` |
| Tvp Vod | `tvp_vod` | `#E71D36` | `com.tvp.vodtv.tv/com.redgemediaportaltv.MainActivity` |
| Tvpsport | `tvpsport` | `#2EC4B6` | `pl.tvp.sport.tv/pl.tvp.sport.tv.presentation.MainActivity` |
| Twilight | `twilight` | `#4CC9F0` | `com.urbandroid.lux/com.urbandroid.lux.TvActivity` |
...
| Twodf Tivi | `twodf_tivi` | `#F15BB5` | `de.zdf.mediathek.tivi/de.zdf.mediathek.tivi.ui.splash.SplashActivity` |
| U | `u` | `#43AA8B` | `uk.co.uktv.dave/uk.co.uktv.dave.UKTVPlayActivity` |
| U Next | `u_next` | `#90BE6D` | `jp.unext.mediaplayer/jp.unext.mediaplayer.main.MainActivity` |
...
| Unreal Debrid | `unreal_debrid` | `#FF477E` | `com.yablio.realdebridtv/com.yablio.realdebridtv.StartActivity` |
| USA Network | `androidtv_9` | `#8AC926` | `com.nbcu.tve.usatv.androidtv/com.nbc.nbctvapp.ui.main.view.MainActivity` |
| Vbtv | `vbtv` | `#F94144` | `dce.fivb.volleyballtv/com.applicaster.ui.activities.MainActivity` |
| Ve Plus | `venevision` | `#2EC4B6` | `com.cisneros.venevision.app/com.interfacectvapp.MainActivity` |
| Veezie | `veezie` | `#00BBF9` | `st.veezie/st.veezie.MainActivity` |
| Vewd Internet Browser | `vewd_internet_browser` | `#00BBF9` | `com.vewd.core.integration.dia/com.vewd.core.browser.BrowserActivity`<br>`com.vewd.core.integration.dia/com.vewd.core.browser.TVActivity` |
| Viaplay | `viaplay` | `#FE365F` | `com.viaplay.android/com.viaplay.android.features.home.HomeActivity` |
| Vibra | `vibra` | `#9B5DE5` | `com.vibra/com.ryanheise.audioservice.AudioServiceActivity` |
| Victory Plus | `victory_plus` | `#9B5DE5` | `tv.apmc.android.victorysports/tv.kidoodle.android.ui.MainActivity` |
| Vidangel | `vidangel` | `#FF477E` | `com.vidangel.tvapp/com.vidangel.tvapp.activities.IntroActivity` |
| Videoland | `videoland` | `#FEE440` | `nl.rtl.videoland.v2/com.bedrockstreaming.shared.tv.activity.SplashActivity` |
...
| Viva One TV | `viva_one_tv` | `#FEE440` | `com.viva.vivaone/com.viva.vivamax.activity.SplashActivity` |
| ViX | `vix` | `#E71D36` | `com.univision.prendetv/com.univision.descarga.tv.ui.MainActivity` |
...
| Vmx | `vmx` | `#2EC4B6` | `com.viva.vivamax/com.viva.vivamax.activity.SplashActivity` |
| Vodafone TV | `vodafone_tv` | `#2EC4B6` | `com.vodafone.vtv.atv.pt/com.witsoftware.vodafonetv.view.splash.SplashActivity` |
| Voyo Sk | `voyo_sk` | `#8AC926` | `net.cme.voyo.sk.tvapp/net.cme.voyo.sk.tvapp.MainActivity` |
| VPN Dot | `omnisoft` | `#9B5DE5` | `com.omnisoft.vpndot/com.omnisoft.vpndot.main` |
| VPN Unlimited | `vpn_unlimited` | `#E71D36` | `com.simplexsolutionsinc.vpn_unlimited/com.simplexsolutionsinc.vpn_unlimited.ui.screens.splash.SplashScreenActivity` |
| vRadio | `vradio` | `#B5179E` | `com.ilv.vradio/com.ilv.vradiotv.MainActivity` |
| VRT MAX | `vrtnu` | `#577590` | `be.vrt.vrtnu/be.vrt.vrtnu.MainActivity` |
| Vstro Player | `vstro_player` | `#9B5DE5` | `com.vs.vsplayer/com.vs.vsplayer.common.view.SplashActivity` |
...
| Watcher TV | `watcher_tv` | `#577590` | `ott.watcherentertainment/tv.vhx.LauncherActivity`<br>`ott.watcherentertainment/tv.vhx.tv.home.TvHomeActivity` |
...
| Wow2 | `wow2` | `#2EC4B6` | `de.sky.online/com.peacock.peacocktv.GoogleMainActivity` |
| Wrestle Universe | `wrestle_universe` | `#F3722C` | `com.wrestle_universe/com.wrestle_universe.MainActivity` |
| WuPlay | `wuplay` | `#FFFFFF` | `app.wuplay.androidtv/app.wuplay.androidtv.MainActivity`<br>`app.wuplay.androidtv/.MainActivity` |
| X TV | `x_tv` | `#90BE6D` | `com.x.xtv/com.x.xtv.MainActivity` |
| X-plore | `lonelycatgames` | `#FF477E` | `com.lonelycatgames.Xplore/com.lonelycatgames.Xplore.Browser`<br>`com.lonelycatgames.Xplore/.Browser` |
| XC IPTV | `nathnetwork_2` | `#FF477E` | `com.nathnetwork.xciptv/com.nathnetwork.xciptv.SplashVideoActivity` |
| Xiaomi Media Player | `xiaomi_media_player` | `#6A4C93` | `com.xiaomi.mitv.mediaexplorer/com.xiaomi.mitv.mediaexplorer.NewScraperMainEntryActivity` |
| Xstream Play | `xstream_play` | `#2EC4B6` | `tv.airtel.xstream.tvapp/tv.airtel.xstream.login.LoginActivity` |
| Xtream Player | `xtreamplayeranddownloader` | `#8AC926` | `com.divergentftb.xtreamplayeranddownloader/com.divergentftb.xtreamplayeranddownloader.start.SpActivity` |
...
| Yoga Download | `yoga_download` | `#4CC9F0` | `com.yogadownload.andtv/com.yogadownload.andtv.SplashScreen` |
| Youcine | `youcine` | `#FEE440` | `com.world.youcinetv/com.interactive.brasiliptv.ui.activity.WelcomeActivity` |
...
| Zapp | `zapp` | `#F15BB5` | `de.christinecoenen.code.zapp/de.christinecoenen.code.zapp.tv.main.MainActivity` |
| Zattoo | `zattoo` | `#2EC4B6` | `com.zattoo.player/com.utv.MainActivity` |
| Zdf | `zdf` | `#FA7D19` | `com.zdf.android.mediathek/com.zdf.android.mediathek.tv.MainActivity` |
| ZEE5 | `graymatrix` | `#FF6B35` | `com.graymatrix.did/com.zee5.android.launch.presentation.AppStartActivity` |
| Zen IPTV | `zeniptv` | `#1982C4` | `app.zeniptv.mobile/app.zeniptv.mobile.MainActivity` |
| Zeus | `zeus` | `#4CC9F0` | `com.thezeusnetwork.www/tv.vhx.LauncherActivity`<br>`com.thezeusnetwork.www/tv.vhx.tv.home.TvHomeActivity` |
