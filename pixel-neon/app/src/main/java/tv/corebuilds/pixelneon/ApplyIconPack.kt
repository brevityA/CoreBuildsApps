...
object ApplyIconPack {
    ...
    val PROJECTIVY = Launcher(
        ...
        manualPath = "Projectivy Settings → Appearance → Cards → Icon Pack → Core Builds Pixel Neon Icon Pack"
    )
    ...
    val MONET = Launcher(
        ...
        manualPath = "Monet Settings → Icons → Icon pack → Core Builds Pixel Neon Icon Pack"
    )
    ...
    val AT4K = Launcher(
        ...
        manualPath = "Open AT4K → Settings → Icon pack → Core Builds Pixel Neon Icon Pack"
    )
