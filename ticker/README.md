...
This copy lives in the **Core Builds Apps** repo (`brevityA/CoreBuildsApps`) alongside the [Core Builds Icon Pack](https://github.com/brevityA/CoreBuildsApps) — one repo, two sideload-ready Android apps.
