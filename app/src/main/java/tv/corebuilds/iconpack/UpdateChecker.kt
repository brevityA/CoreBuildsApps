...
object UpdateChecker {
    ...
    // Primary location (this repo). Fallback keeps already-installed 1.5.1
    // packs polling the old name working after the CoreBuildsIconPack ->
    // CoreBuildsApps rename. Both hosts are the same file.
