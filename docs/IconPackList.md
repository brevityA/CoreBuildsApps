...
| 3Player | `threeplayer` | `#FF4D4D` | `#FF4D4D` | `com.axonista.threeplayer/com.simplestream.presentation.startup.StartUpActivity` |
...
| Ace Stream | `ace_stream` | `#FFE14D` | `#FFE14D` | `org.acestream.node/org.acestream.engine.ui.MainWebViewActivity` |
...
| AI Cam View | `aicamview` | `#A366FF` | `#A366FF` | `com.kapron.ap.aicamview.tv/com.kapron.ap.aicamview.tv.CameraListActivityTv` |
...
| Aircast | `aircast` | `#53FC18` | `#53FC18` | `com.smartdevice.tv.aircast/com.coocaa.icast.ui.home.SplashActivity` |
| Airpin Pro | `airpin_pro` | `#7C74FF` | `#7C74FF` | `com.waxrain.airplaydmr/com.waxrain.ui.WaxPlayerSetting` |
| AirPlay Receiver | `receiver` | `#FF7A2E` | `#FF7A2E` | `com.boost.airplay.receiver/com.boost.airplay.receiver.ui.activity.SplashActivity` |
...
| Amazing Classics | `amazing_classics` | `#FF4D4D` | `#FF4D4D` | `stormcastcinema.amazing.classics/stormcastcinema.westernmania.ui.splash.SplashActivity` |
| Amazon Freevee | `livingroom` | `#1FD19A` | `#1FD19A` | `com.imdbtv.livingroom/com.amazon.ignition.MainActivity` |
...
| Amnis | `amnis` | `#C95CFF` | `#C95CFF` | `com.amnis/com.amnis.gui.MainActivity` |
...
| Apk Installer | `apk_installer` | `#7C74FF` | `#7C74FF` | `com.uptodown.installer/com.uptodown.installer.activity.SplashActivity` |
...
| App Generation | `appgeneration` | `#3D8BFF` | `#3D8BFF` | `com.appgeneration.itunerfree/com.appgeneration.mytunertv.activities.TvActivity` |
| App Notifier | `appnotifier` | `#FF4D4D` | `#FF4D4D` | `com.farmerbb.appnotifier/com.farmerbb.appnotifier.ui.MainActivity` |
...
| AppLinked | `applinkednew` | `#1FD19A` | `#1FD19A` | `com.i4apps.applinkednew/com.applinked.applinkedapp.SplashScreenActivity` |
...
| Bell Fibe | `bellmediaplayer` | `#B6F23A` | `#B6F23A` | `com.quickplay.android.bellmediaplayer/ca.bell.fiberemote.boot.BootstrapActivity`<br>`com.quickplay.android.bellmediaplayer/ca.bell.fiberemote.tv.MainTvActivity` |
...
| Blip | `blip` | `#FF4D4D` | `#FF4D4D` | `net.blip.android/net.blip.android.MainActivity` |
...
| BODi | `beachbody` | `#C95CFF` | `#C95CFF` | `com.beachbody.bod/com.beachbody.bodfiretv.activities.SplashActivity` |
...
| Bravia Core | `bravia_core` | `#E6EDF3` | `#E6EDF3` | `com.sonypicturescore/com.sphe.bravialounge.SplashActivity` |
...
| Byebyedpi | `byebyedpi` | `#7C74FF` | `#7C74FF` | `io.github.romanvht.byedpi/io.github.dovecoteescapee.byedpi.activities.MainActivity` |
| Byutv | `byutv` | `#FF7A2E` | `#FF7A2E` | `org.byutv.android/org.byutv.android.MainActivity` |
| Cafe Bazaar | `farsitel` | `#19D3C5` | `#19D3C5` | `com.farsitel.bazaar.tv/com.farsitel.bazaar.tv.ui.splash.SplashActivity` |
| Caixaforum Plus | `caixaforum_plus` | `#F04DE0` | `#F04DE0` | `es.caixaforum.cxplus/com.mediapro.caixaforum.view.splash.SplashActivity` |
| Canal Digital | `canaldigital` | `#B6F23A` | `#B6F23A` | `com.canaldigital.go/com.rdyrn.MainActivity` |
| CANAL+ | `canal` | `#3D8BFF` | `#3D8BFF` | `com.canal.android.canal/com.canal.ui.tv.TvMainActivity` |
| Capsule | `capsule` | `#FF4D4D` | `#FF4D4D` | `studio.goodegg.capsule/studio.goodegg.capsule.tv.MainActivity` |
| Cast4K | `cast4k` | `#1FD19A` | `#1FD19A` | `com.bigint.cast4k/com.bigint.iptv.presentation.MainActivity` |
...
| Cda Pl | `cda_pl` | `#FFE14D` | `#FFE14D` | `pl.cda.tv/pl.cda.tv.ui.welcome.WelcomeActivity` |
| CGTN America | `cgtnamericanow` | `#4FACFE` | `#4FACFE` | `com.cgtnamericanow/tv.vhx.LauncherActivity`<br>`com.cgtnamericanow/tv.vhx.tv.home.TvHomeActivity` |
...
| Chaupal | `chaupal` | `#34EB7A` | `#34EB7A` | `video.laminar.tv.chaupal.android/com.yupptv.ott.ui.activity.SplashActivity` |
...
| Cinemaghar TV | `cinemaghar_tv` | `#FFB020` | `#FFB020` | `com.thesunbi.cinemaghartv/com.thesunbi.cinemaghartv.ui.main.MainActivity` |
...
| Citytv+ | `citytvplus` | `#53FC18` | `#53FC18` | `com.rogers.citytvplus/com.rogers.citytvplus.presentation.LauncherActivity` |
| Clash Meta | `metacubex` | `#7C74FF` | `#7C74FF` | `com.github.metacubex.clash.meta/com.github.kr328.clash.MainActivityAlias` |
...
| Coji TV Browser | `coji_tv_browser` | `#F04DE0` | `#F04DE0` | `mvl.studio.tvlite/mvl.studio.tvlite.android_tv.presentation.ui.TabletLauncherActivity`<br>`mvl.studio.tvlite/mvl.studio.tvlite.android_tv.presentation.ui.HomeLauncherActivity` |
...
| Cosmote TV | `cosmote_tv` | `#1FD19A` | `#1FD19A` | `gr.cosmote.cosmotetv.androidtv/dt.ote.poc.presentation.view.tv.TvActivity` |
| Couch Puzzles | `couch_puzzles` | `#C95CFF` | `#C95CFF` | `com.roysolberg.couchpuzzles/com.roysolberg.couchpuzzles.AndroidLauncher` |
...
| Mytvonline | `mytvonline` | `#34EB7A` | `#34EB7A` | `m.formuler.mol.plus/m.formuler.mol.plus.IntroActivity` |
| Māori+ | `maoritelevision` | `#A366FF` | `#A366FF` | `com.maoritelevision.newsapp/tv.accedo.xdk.app.MainActivity` |
| Namava | `namava` | `#FFB020` | `#FFB020` | `com.shatelland.namava.tv/com.shatelland.namava.splash_tv.splash.SplashActivity` |
...
| Netfly | `netfly` | `#00D4FF` | `#00D4FF` | `br.com.netfly.oletv/br.tv.ole.oletv.MainActivity` |
| Netfly TV | `netfly_tv` | `#FF5CA8` | `#FF5CA8` | `xyz.netfly/com.video_cloud.SplashActivity` |
...
| Nettv | `nettv` | `#7C74FF` | `#7C74FF` | `np.com.androidtv.nettv/com.np.androidTV.main.TVMainActivity` |
| Netzkino | `netzkino` | `#FF7A2E` | `#FF7A2E` | `de.netzkino.android.ics/de.netzkino.android.ics.SplashActivity` |
...
| Nfolio | `nfolio` | `#3D8BFF` | `#3D8BFF` | `com.snapwood.nfolio/com.snapwood.gfolio.SelectAlbumActivity` |
| Nhk Plus | `nhk_plus` | `#FF4D4D` | `#FF4D4D` | `jp.nhk.plus/jp.nhk.simul.view.activity.SplashActivity` |
| Nhk World Japan | `nhk_world_japan` | `#1FD19A` | `#1FD19A` | `jp.or.nhk.nhkworld.tv/jp.or.nhk.nhkworld.tv.ui.MainActivity` |
...
| Nlziet | `nlziet` | `#FFE14D` | `#FFE14D` | `nl.nlziet/nl.nlziet.tv.app.di.tv.InjectActivity` |
...
| Noovo | `noovo` | `#4FACFE` | `#4FACFE` | `com.vmediagroup.noovo/entpay.awl.tv.splash.SplashActivity` |
...
| Nostalgia TV | `nostalgiatv` | `#FFB020` | `#FFB020` | `com.nostalgiatv/com.nostalgiatv.MainActivity` |
...
| Nowo TV | `nowo_tv` | `#7C74FF` | `#7C74FF` | `pt.nowo.nowotv.androidtv/com.androme.andrometv.ui.boot.SplashScreenActivity` |
| Npo Start | `npo_start` | `#FF7A2E` | `#FF7A2E` | `nl.uitzendinggemist/nl.uitzendinggemist.tv.presentation.activities.main.MainActivity` |
| Nrk TV | `nrk_tv` | `#19D3C5` | `#19D3C5` | `no.nrk.tv/no.nrk.tv.view.MobileSplashScreenActivity`<br>`no.nrk.tv/no.nrk.tv.view.TvSplashScreenActivity` |
...
| NZR+ | `nzrplus` | `#FF4D4D` | `#FF4D4D` | `com.nzrplus.app/com.nzrplus.app.MainActivity` |
| Oblivion | `oblivion` | `#1FD19A` | `#1FD19A` | `org.bepass.oblivion/org.bepass.oblivion.ui.SplashScreenActivity` |
...
| Oilers+ | `oilers` | `#E6EDF3` | `#E6EDF3` | `com.oilers.app/com.imggaming.dicemobile.MainActivity` |
...
| Omroep Brabant | `appomroepbrabant` | `#00D4FF` | `#00D4FF` | `com.appomroepbrabant/com.applicaster.ui.activities.MainActivity` |
| Ondamedia | `ondamedia` | `#FF5CA8` | `#FF5CA8` | `com.mdstrm.ondamedia/com.mdstrm.ondamedia.MainActivity` |
| One Play | `one_play` | `#53FC18` | `#53FC18` | `net.cme.voyo.cz.tvapp/net.cme.voyo.cz.tvapp.MainActivity` |
...
| OnTV | `andevapps` | `#19D3C5` | `#19D3C5` | `com.andevapps.ontv/limehd.ru.ctv.MainActivity` |
| Openvpn For Android | `openvpn_for_android` | `#EA7E20` | `#EA7E20` | `de.blinkt.openvpn/de.blinkt.openvpn.activities.MainActivity` |
| Opta / SIC | `impresa` | `#F04DE0` | `#F04DE0` | `com.impresa.opta/com.magycal.androidott.ui.tv.TVBaseActivity` |
| Oqee By Free | `oqee_by_free` | `#B6F23A` | `#B6F23A` | `net.oqee.androidmobile/net.oqee.android.ui.splash.SplashActivity` |
| Orange TV Go | `orange_tv_go` | `#3D8BFF` | `#3D8BFF` | `ro.orange.tvlive/tv.solocoo.htmlapp.FullscreenActivity` |
| ORF ON | `orftvthek` | `#FF4D4D` | `#FF4D4D` | `com.nousguide.android.orftvthek/com.nousguide.android.orftvthek.MainActivity` |
...
| OTTplay | `ottplay` | `#E6EDF3` | `#E6EDF3` | `com.ottplay.ottplay/com.ottplay.ottplay.StartActivity` |
...
| Panda Plus | `panda_plus` | `#FF5CA8` | `#FF5CA8` | `pt.dreamia.pandaplus/com.magycal.androidott.ui.tv.TVBaseActivity` |
| Pandora | `pandora` | `#00A0EE` | `#00A0EE` | `com.pandora.android.atv/com.pandora.android.MainActivity` |
| Pano Scrobbler | `scrobble` | `#53FC18` | `#53FC18` | `com.arn.scrobble/com.arn.scrobble.main.MainActivity` |
...
| Pathethuis | `pathethuis` | `#7C74FF` | `#7C74FF` | `nl.pathe.thuis/nl.pathe.thuis.LaunchActivity` |
...
| PigeonCast | `pigeoncast` | `#C95CFF` | `#C95CFF` | `com.pigeoncast.screen.mirroring.android.tv/com.mirror_universal.receiver.activity.MainActivity` |
| PikPak | `pikcloud` | `#FFE14D` | `#FFE14D` | `com.pikcloud.pikpak/com.pikcloud.app.SplashActivity`<br>`com.pikcloud.pikpak/com.pikcloud.app.TVLaunchActivity` |
| Play Now | `playnow` | `#4FACFE` | `#4FACFE` | `com.play.playnow.tv/com.n7mobile.playbox.ui.MainActivity` |
| Play Suisse | `playsuisse` | `#E6EDF3` | `#E6EDF3` | `ch.srgssr.playsuisse.tv/ch.srgssr.playsuisse.tv.MainActivity` |
| Play Universal | `universal` | `#34EB7A` | `#34EB7A` | `com.play.universal/com.play.universal.MainActivity` |
...
| PMX | `pmx` | `#F04DE0` | `#F04DE0` | `com.mirfatif.permissionmanagerx/com.mirfatif.permissionmanagerx.fwk.MainActivityM`<br>`com.mirfatif.permissionmanagerx/com.mirfatif.permissionmanagerx.fwk.MainActivity` |
...
| Ppsspp | `ppsspp` | `#FF4D4D` | `#FF4D4D` | `org.ppsspp.ppsspp/org.ppsspp.ppsspp.PpssppActivity` |
...
| Premiere FC | `premierefc` | `#C95CFF` | `#C95CFF` | `br.tv.horizonte.android.premierefc/br.tv.horizonte.android.premierefc.splash_tv.SplashTvActivity` |
...
| Privado VPN | `privado_vpn` | `#4FACFE` | `#4FACFE` | `io.privado.android/io.privado.android.ui.splash.SplashActivity` |
...
| Projectivy Categories | `projectivy_categories` | `#E6EDF3` | `#E6EDF3` | `com.spocky.projengmenu/.ui.guidedActions.activities.shortcut.CategoryShortcutActivity`<br>`com.spocky.projengmenu/.ui.launcherActivities.CategoryShortcutActivity` |
| Projectivy Channels | `projectivy_channels` | `#34EB7A` | `#34EB7A` | `com.spocky.projengmenu/.ui.guidedActions.activities.shortcut.ChannelShortcutActivity`<br>`com.spocky.projengmenu/.ui.launcherActivities.ChannelShortcutActivity` |
...
| Projectivy Overflight | `projectivy_overflight` | `#A366FF` | `#A366FF` | `tv.projectivy.plugin.wallpaperprovider.overflight/tv.projectivy.plugin.wallpaperprovider.overflight.SettingsActivity` |
| Projectivy Settings | `projectivy_settings` | `#FFB020` | `#FFB020` | `com.spocky.projengmenu/.ui.settings.SettingsActivity`<br>`com.spocky.projengmenu/.ui.guidedActions.activities.settings.AppSettingsActivity` |
| Proton VPN | `protonvpn` | `#66DEB1` | `#66DEB1` | `ch.protonvpn.android/com.protonvpn.android.tv.main.TvMainActivity` |
| Psiphon | `subscription` | `#00D4FF` | `#00D4FF` | `com.psiphon3.subscription/com.psiphon3.MainActivity` |
...
| Quasitv | `quasitv` | `#19D3C5` | `#19D3C5` | `gonemad.quasi.tv/gonemad.quasi.tv.ui.MainActivity` |
...
| Quicksupport | `quicksupport` | `#B6F23A` | `#B6F23A` | `com.teamviewer.quicksupport.market/com.teamviewer.quicksupport.ui.QSActivity` |
...
| Radio Paradise | `radioparadisewidget` | `#1FD19A` | `#1FD19A` | `com.earthflare.android.radioparadisewidget.gpv2/com.cratorsoft.act.ActRPHD`<br>`com.earthflare.android.radioparadisewidget.gpv2/com.cratorsoft.act.ActRPHD_` |
| Radioline | `radioline` | `#C95CFF` | `#C95CFF` | `com.radioline.android.radioline/com.radioline.android.radioline.MainActivity` |
| Radioplayer | `radioplayer` | `#FFE14D` | `#FFE14D` | `com.radioplayer.mobile/com.radioplayer.mobile.MainActivity` |
| Raiplay | `raiplay` | `#4FACFE` | `#4FACFE` | `it.rainet.androidtv/it.rainet.androidtv.ui.MainLeanbackActivity` |
| Rakuten TV | `rakuten_tv` | `#BF0000` | `#C40000` | `tv.wuaki.apptv/tv.wuaki.apptv.activity.TVLaunchActivity` |
| Rally TV | `rally_tv` | `#E6EDF3` | `#E6EDF3` | `laola1.wrc/com.redbull.rallytv.core.MainActivity` |
...
| Redream | `redream` | `#7C74FF` | `#7C74FF` | `io.recompiled.redream/io.recompiled.redream.MainActivity` |
| Refreshrate | `refreshrate` | `#FF7A2E` | `#FF7A2E` | `mobi.bytearray.refreshrate/mobi.bytearray.refreshrate.SettingsActivity` |
...
| Replaio Radio | `replaio` | `#B6F23A` | `#B6F23A` | `com.hv.replaio/com.hv.replaio.activities.tv.StartActivityTV` |
| RetroArch | `retroarch` | `#000000` | `#E6EDF3` | `com.retroarch/com.retroarch.browser.mainmenu.MainMenuActivity` |
| RetroX | `archain` | `#3D8BFF` | `#3D8BFF` | `com.archain.retrox/com.unity3d.player.UnityPlayerActivity` |
| Rezka | `rezka` | `#FF4D4D` | `#FF4D4D` | `ru.astroapps.hdrezka/ru.astroapps.hdrezka.MainActivity` |
| Riks TV | `riks_tv` | `#1FD19A` | `#1FD19A` | `no.rikstv.atv/no.rikstv.atv.MainActivity` |
| RlaXX TV | `rlaxxtv` | `#C95CFF` | `#C95CFF` | `com.rlaxxtv.tvapp.atv/com.rlaxxtv.tvapp.MainActivity` |
| RLC+ | `rlcplus` | `#FFE14D` | `#FFE14D` | `com.rlcplus.app/com.rlcplus.app.MainActivity` |
...
| RSI Play | `rsi` | `#34EB7A` | `#34EB7A` | `ch.rsi.player/ch.srg.srgplayer.tv.MainActivity` |
| RTBF Auvio | `auvio` | `#A366FF` | `#A366FF` | `be.rtbf.auvio/com.dotscreen.ethanol.tv.ui.MainActivity` |
| RTE Player | `minimal` | `#FFB020` | `#FFB020` | `air.RTE.OSMF.Minimal/com.finconsgroup.droid.activities.MainActivity`<br>`air.RTE.OSMF.Minimal/com.finconsgroup.droid.activities.TvActivity` |
| RTL | `rtl` | `#FA002E` | `#FA002E` | `de.rtli.tvnow/de.rtl.plus.RtlPlusLauncherActivity` |
| RTL Play | `rtl_play` | `#00D4FF` | `#00D4FF` | `com.tapptic.rtl.tvi/be.persgroep.rtlplay.RtlPlayMainActivity` |
| RTP Play | `rtp_play` | `#FF5CA8` | `#FF5CA8` | `pt.rtp.play/pt.rtp.play.IntroActivity` |
| RTVE Play | `rtve_play` | `#53FC18` | `#53FC18` | `com.rtve.androidtv/com.rtve.androidtv.Activity.SplashActivity` |
| Rugbypass TV | `rugbypass_tv` | `#7C74FF` | `#7C74FF` | `com.worldrugbypass.app/com.worldrugbypass.app.MainActivity` |
...
| Saff | `saff` | `#F04DE0` | `#F04DE0` | `sa.saffplus/com.mottostreaming.android.tv.MainActivity` |
...
| Scholastic | `scholastic` | `#3D8BFF` | `#3D8BFF` | `com.future.scholastic/com.future.scholastic.SplashActivity` |
...
| Sd Maid | `sd_maid` | `#1FD19A` | `#1FD19A` | `eu.thedarken.sdm/eu.thedarken.sdm.main.ui.SDMMainActivity` |
| SD Maid SE | `sdmaid` | `#8BC34A` | `#8BC34A` | `eu.darken.sdmse/.main.ui.MainActivity` |
| SeerrTV | `seerrtv` | `#C95CFF` | `#C95CFF` | `ca.devmesh.seerrtv/ca.devmesh.seerrtv.MainActivity` |
| Send Files to TV | `sendfilestotv` | `#2979FF` | `#2979FF` | `com.yablio.sendfilestotv/.ui.MainActivity` |
| SeriesGuide | `battlelancer` | `#FFE14D` | `#FFE14D` | `com.battlelancer.seriesguide/com.battlelancer.seriesguide.ui.ShowsActivity` |
...
| Sfjazz At Home | `sfjazz_at_home` | `#E6EDF3` | `#E6EDF3` | `com.sfjazzdigital/tv.vhx.LauncherActivity`<br>`com.sfjazzdigital/tv.vhx.tv.home.TvHomeActivity` |
| Sfr TV | `sfr_tv` | `#34EB7A` | `#34EB7A` | `com.sfr.androidtv.gen8/com.sfr.androidtv.gen8.ui.Tv8MainActivity` |
...
| Sledovani | `sledovani` | `#B6F23A` | `#B6F23A` | `cz.sledovanitv.android/cz.sledovanitv.androidtv.entry.EntryActivity` |
...
| Snapcast | `snapcast` | `#FF4D4D` | `#FF4D4D` | `de.badaix.snapcast/de.badaix.snapcast.MainActivity` |
...
| Sooner | `sooner` | `#E6EDF3` | `#E6EDF3` | `sooner.app.de/de.eyzmedia.sooner.MainActivity` |
...
| SRF Play | `srfplayer` | `#19D3C5` | `#19D3C5` | `ch.srf.mobile.srfplayer/ch.srg.srgplayer.tv.MainActivity` |
...
| STB Emu | `mvas` | `#FF4D4D` | `#FF4D4D` | `com.mvas.stb.emu.free/com.mvas.stbemu.activities.MainActivity` |
...
| Streamlocator VPN | `streamlocator_vpn` | `#FFE14D` | `#FFE14D` | `com.streamlocator.vpn/com.streamlocator.vpn.ui.tv.home.TVHomeActivity` |
...
| Stremize | `stremize` | `#34EB7A` | `#34EB7A` | `com.stremize.player/.MainActivity`<br>`com.stremize.player/com.stremize.player.MainActivity` |
| Strexo Player | `strexo` | `#E91E63` | `#E91E63` | `com.callum.strexoplayer/.LoginActivity` |
| Strim | `strim` | `#A366FF` | `#A366FF` | `no.strim.atv/no.rikstv.atv.MainActivity` |
| Strmr | `strmr` | `#FF3366` | `#FF3366` | `com.strmr.ps/com.strmr.ps.ui.auth.SignInActivity`<br>`com.strmr.ps/.ui.auth.SignInActivity` |
| Strongvpn | `strongvpn` | `#FFB020` | `#FFB020` | `com.strongvpn/com.strongvpn.ui.activities.SplashActivity` |
| Stv Player | `stv_player` | `#00D4FF` | `#00D4FF` | `tv.stv.android.player/tv.stv.android.commontv.screens.TvActivity` |
| Sunnxt | `sunnxt` | `#FF5CA8` | `#FF5CA8` | `com.suntv.sunnxt/com.androidtv.myplex.ui.activity.SPlashActivity` |
...
| Sweet TV | `sweet_tv` | `#19D3C5` | `#19D3C5` | `tv.sweet.tvplayer/tv.sweet.tvplayer.MainActivity` |
| SYFY | `androidtv_8` | `#F04DE0` | `#F04DE0` | `com.nbcu.tve.syfy.androidtv/com.nbc.nbctvapp.ui.main.view.MainActivity` |
| Symfonik | `symfonik` | `#B6F23A` | `#B6F23A` | `app.symfonik.music.player/app.symfonik.ui.MainActivity`<br>`app.symfonik.music.player/app.symfonik.ui.StartActivity` |
...
| Synologyphotos | `synologyphotos` | `#3D8BFF` | `#3D8BFF` | `com.synology.projectkailash/com.synology.projectkailash.ui.login.LoginActivity` |
| Tabii | `tabii` | `#FF4D4D` | `#FF4D4D` | `com.trt.tabii.android/com.trt.tabii.android.tv.MainActivity` |
| Tablo | `tablofast` | `#1FD19A` | `#1FD19A` | `com.nuvyyo.TabloFAST/com.nuvyyo.tablo.LaunchActivity` |
| Tailscale | `tailscale` | `#222222` | `#E6EDF3` | `com.tailscale.ipn/com.tailscale.ipn.MainActivity` |
| Talk TV | `talk_tv` | `#C95CFF` | `#C95CFF` | `uk.co.news.talkradiotv/com.simplestream.presentation.startup.StartUpActivity` |
| Talksport | `talksport` | `#FFE14D` | `#FFE14D` | `com.talksport.tsliveen/com.simplestream.presentation.startup.StartUpActivity` |
...
| Tbn Plus | `tbn_plus` | `#E6EDF3` | `#E6EDF3` | `tbn_mobile.android/com.applicaster.ui.activities.MainActivity` |
| TBS | `tbs` | `#34EB7A` | `#34EB7A` | `com.turner.tbs.android.networkapp/com.wme.app.MainActivityTv` |
| TCL Channel | `tcl_channel` | `#A366FF` | `#A366FF` | `com.tcl.waterfall.overseas/com.tcl.waterfall.overseas.main.MainActivity` |
| TCL Home | `tcl_home` | `#FFB020` | `#FFB020` | `com.tcl.tclhome/com.tcl.bmmain.SplashActivity` |
| TCL Home Passive | `tcl_home_passive` | `#00D4FF` | `#00D4FF` | `com.tcl.tv.tclhome_passive/com.tcl.tv.tclhome_passive.HomePassiveActivity` |
| Tcn | `tcn` | `#FF5CA8` | `#FF5CA8` | `com.tuckercarlson.tv/tv.accedo.one.app.bootstrap.BootstrapActivity` |
...
| Tele Quebec | `tele_quebec` | `#FF7A2E` | `#FF7A2E` | `tv.telequebec/uk.tva.template.LaunchScreenActivity` |
...
| Telenet | `telenet` | `#F04DE0` | `#F04DE0` | `be.telenet.tv/com.libertyglobal.horizonx.MainActivity` |
...
| Telewebion | `telewebion` | `#3D8BFF` | `#3D8BFF` | `tv.telewebion/tv.telewebion.ui.main.MainActivity` |
| Teliaplaylt | `teliaplaylt` | `#FF4D4D` | `#FF4D4D` | `lt.telia.tv/lt.telia.tv.MainActivity` |
| Telly | `telly` | `#1FD19A` | `#1FD19A` | `tv.fournetwork.android.box.digi/tv.fournetwork.android.box.MainActivity` |
...
| Tennistv | `tennistv` | `#4FACFE` | `#4FACFE` | `com.tennistv.cdtv/com.tennistv.cdtv.MainActivity` |
| Termux | `termux` | `#000000` | `#E6EDF3` | `com.termux/com.termux.app.TermuxActivity` |
| Texttv | `texttv` | `#34EB7A` | `#34EB7A` | `com.vonlegohufvud.texttvsv/com.vonlegohufvud.texttvsv.MainActivity` |
| Tf1 | `tf1` | `#A366FF` | `#A366FF` | `fr.tf1.mytf1/fr.tf1.mytf1.MainActivity` |
| TFC | `tfctv` | `#FFB020` | `#FFB020` | `com.absi.tfctv/com.absi.tfctv.MainActivity` |
...
| The Weather Network | `weathereyeandroid` | `#FF7A2E` | `#FF7A2E` | `com.pelmorex.WeatherEyeAndroid.tv/com.pelmorex.WeatherEyeAndroid.tv.ui.activities.SplashActivity` |
| Thmanyah | `thmanyah` | `#19D3C5` | `#19D3C5` | `com.thmanyah.shasha.tv/com.thmanyah.shasha.SplashActivity` |
| ThreeNow | `mediaworks` | `#F04DE0` | `#F04DE0` | `com.mediaworks.android.tv/nz.co.mediaworks.vod.ui.MainActivity` |
...
| Timvision | `timvision` | `#3D8BFF` | `#3D8BFF` | `it.telecomitalia.cubovision/com.canal.ui.tv.TvMainActivity` |
| Tivify | `tivify` | `#FF4D4D` | `#FF4D4D` | `com.tvup.tivify.app.tv/com.tvup.tvapp.view.activity.MainActivityTVup` |
...
| TNA Wrestling | `fight` | `#1FD19A` | `#1FD19A` | `com.fight.tna/com.fight.tna.MainActivity` |
| TNT | `tnt` | `#C95CFF` | `#C95CFF` | `com.turner.tnt.android.networkapp/com.wme.app.MainActivityTv` |
| Tod | `tod` | `#FFE14D` | `#FFE14D` | `com.todtv.tod/com.todtv.tod.MainActivity` |
| Toggo | `toggo` | `#4FACFE` | `#4FACFE` | `de.toggo/de.toggo.vod.ui.MainActivityToggo` |
| Top Radio | `top_radio` | `#E6EDF3` | `#E6EDF3` | `nl.angrybytes.apps.topradio/nl.angrybytes.apps.topradio.Activities.TVActivity` |
...
| Torrent Search | `torrentsearchengine` | `#34EB7A` | `#34EB7A` | `biz.softwareits.torrentsearchengine/com.abc.abc.torrent_search_app_flutter.MainActivity` |
| Torrserve | `torrserve` | `#A366FF` | `#A366FF` | `ru.yourok.torrserve/ru.yourok.torrserve.ui.activities.main.MainActivity` |
...
| Trilogy Plus | `trilogy_plus` | `#00D4FF` | `#00D4FF` | `ott.trilogyplus/tv.vhx.LauncherActivity`<br>`ott.trilogyplus/tv.vhx.tv.home.TvHomeActivity` |
| Trublu | `trublu` | `#FF5CA8` | `#FF5CA8` | `ott.trublu/tv.vhx.LauncherActivity`<br>`ott.trublu/tv.vhx.tv.home.TvHomeActivity` |
| TSN | `tsn` | `#53FC18` | `#53FC18` | `ca.tsn.mobile.android/ca.tsn.mobile.android.main.activity.MainActivity` |
| Tt | `tt` | `#7C74FF` | `#7C74FF` | `ott.ttplus/tv.vhx.tv.home.TvHomeActivity` |
...
| TV 2 Play | `tv_2_play` | `#19D3C5` | `#19D3C5` | `no.tv2.sumo/no.tv2.android.ui.LauncherBridgeActivity` |
...
| Vtvgo TV | `vtvgo_tv` | `#34EB7A` | `#34EB7A` | `vn.vtv.vtvgotv/com.vtvcab.activities.NewSplashActivity` |
| Waipu TV | `waipu_tv` | `#A366FF` | `#A366FF` | `de.exaring.waipu/de.exaring.waipu.ui.login.LoginActivity` |
| Wako | `wako` | `#FFB020` | `#FFB020` | `app.wako/app.wako.MainActivity` |
| WATCHA | `frograms` | `#00D4FF` | `#00D4FF` | `com.frograms.wplay/com.frograms.wplay.activity.InitActivity` |
| Watcher TV | `watcher_tv` | `#FF5CA8` | `#FF5CA8` | `ott.watcherentertainment/tv.vhx.LauncherActivity`<br>`ott.watcherentertainment/tv.vhx.tv.home.TvHomeActivity` |
...
| World Radios | `worldradios` | `#C95CFF` | `#C95CFF` | `com.digitalapps.worldradios/com.digitalapps.worldradios.activities.ActivitySplash` |
| Wow | `wow` | `#FFE14D` | `#FFE14D` | `tv.vhx.worldofwonder/tv.vhx.LauncherActivity`<br>`tv.vhx.worldofwonder/tv.vhx.tv.home.TvHomeActivity` |
| Wow2 | `wow2` | `#4FACFE` | `#4FACFE` | `de.sky.online/com.peacock.peacocktv.GoogleMainActivity` |
...
| XC IPTV | `nathnetwork_2` | `#FFB020` | `#FFB020` | `com.nathnetwork.xciptv/com.nathnetwork.xciptv.SplashVideoActivity` |
...
| Xstream Play | `xstream_play` | `#FF5CA8` | `#FF5CA8` | `tv.airtel.xstream.tvapp/tv.airtel.xstream.login.LoginActivity` |
...
| Yettel Selfcare | `selfcare` | `#F04DE0` | `#F04DE0` | `bg.yettel.tv.selfcare/bg.yettel.tv.selfcare.MainActivity` |
| Yettel TV | `yettel_tv` | `#B6F23A` | `#B6F23A` | `rs.yettel.tv/rs.yettel.tv.MainActivity` |
| Yippee | `yippee` | `#3D8BFF` | `#3D8BFF` | `com.yippeeentertainment/tv.vhx.tv.home.TvHomeActivity` |
| Yle Areena | `yle_areena` | `#FF4D4D` | `#FF4D4D` | `com.yle.webtv/fi.yle.areena.leanback.ui.LaunchActivity` |
| Yoga Download | `yoga_download` | `#1FD19A` | `#1FD19A` | `com.yogadownload.andtv/com.yogadownload.andtv.SplashScreen` |
| Youcine | `youcine` | `#C95CFF` | `#C95CFF` | `com.world.youcinetv/com.interactive.brasiliptv.ui.activity.WelcomeActivity` |
| Youku | `youku` | `#FFE14D` | `#FFE14D` | `com.youku.intl.tv/com.youku.tv.home.activity.HomeActivity` |
...
| Yowindow | `yowindow` | `#E6EDF3` | `#E6EDF3` | `yo.app.free/yo.activity.MainActivity`<br>`yo.app.free/yo.tv.TvActivity` |
| Zaap TV | `zaap_tv` | `#34EB7A` | `#34EB7A` | `com.zaaptv.mw.client.atv/com.alphaott.webtv.client.launcher.SystemLauncherActivity` |
| Zank Remote | `zank_remote` | `#A366FF` | `#A366FF` | `zank.remote/zank.remote.MainActivity`<br>`zank.remote/zank.remote.AndroidTV` |
| Zapp | `zapp` | `#FFB020` | `#FFB020` | `de.christinecoenen.code.zapp/de.christinecoenen.code.zapp.tv.main.MainActivity` |
| Zattoo | `zattoo` | `#00D4FF` | `#00D4FF` | `com.zattoo.player/com.utv.MainActivity` |
...
| Zeus | `zeus` | `#53FC18` | `#53FC18` | `com.thezeusnetwork.www/tv.vhx.LauncherActivity`<br>`com.thezeusnetwork.www/tv.vhx.tv.home.TvHomeActivity` |
| Ziggo Go TV | `ziggo_go_tv` | `#7C74FF` | `#7C74FF` | `com.ziggo.tv/com.libertyglobal.horizonx.MainActivity` |
| Zona | `zona` | `#FF7A2E` | `#FF7A2E` | `mobi.zona/mobi.zona.ui.MainActivity` |
