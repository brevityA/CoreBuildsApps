...
MIRROR_FILES = [
    ...
    "values/colors.xml",
    "values/themes.xml",
    # Generated auditor deep-link fmt (tools/build_issue_prefills.py). The
...
def main() -> int:
    ...
    d = ['<?xml version="1.0" encoding="utf-8"?>',
         '<!-- Generated by tools/build_pop.py. Do not edit by hand. -->',
         '<resources>']
    # Square glyphs first — the shipped default since 1.9.2, matching what
    # the appfilter now maps. The banner-shaped art follows; Projectivy
    # furniture stays at the head of the banner groups because those cards
    # exist only as banner art (restart/wallpaper toggles have no square
    # variant) and the iconback/mask/upon drawables stay listed nowhere:
    # compositing inputs, not icons.
    for cat in order:
